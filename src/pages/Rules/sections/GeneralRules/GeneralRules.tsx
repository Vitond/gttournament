...
const GeneralRules = () => {
    return <Section className={classes.GeneralRules}>
        ...
        <Paragraph className={classes.GeneralRules__paragraph}>Registrace probíhá přes webové stránky turnaje, případně přes dotazník v Microsoft Forms, pokud účastník dotazník obdržel před otevřením registrace na webových stránkách</Paragraph>
        ...
        <Paragraph className={classes.GeneralRules__paragraph}>Každý účastník musí být studentem nebo učitelem na střední škole nebo na osmiletém gymnáziu.</Paragraph>
        ...
        <Paragraph className={classes.GeneralRules__paragraph}>Je zakázáno používat vulgární jména hráčů, vulgární názvy týmů</Paragraph>
